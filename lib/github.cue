...
inputs: "\(_lib.github.#input)": {
	match: "github-event": or([
	...
	value: "github-event": {
		revision:
			value."github-event".pull_request.head.sha | // PR
			value."github-event".head_commit.id // push
	}
}
...
output: {
	...
	[string]: revision: event.revision
}
